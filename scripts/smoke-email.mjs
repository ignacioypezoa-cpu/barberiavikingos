...
const save = await fetch(`${base}/api/admin/email-config`, {
  ...
  body: JSON.stringify({
    ...
    fromName: "Vikingos", adminEmail: "admin@vikingos.cl", enabled: false
  })
});
...
await prisma.emailConfig.update({
  where: { id: "main" },
  data: { smtpHost: "", smtpPort: 587, smtpUser: "", smtpPassword: "", smtpSecure: false, fromEmail: "reservas@vikingos.cl", fromName: "Vikingos", adminEmail: "admin@vikingos.cl", enabled: false }
});
